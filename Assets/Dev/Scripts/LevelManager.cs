...
public class LevelManager : MonoBehaviour, IManageable
{
    ...
    public async void LaunchLevel(int index)
    {
        ...
        UIManager.instance.DisplaySpecificScreens(new UIScreenTypes[] { UIScreenTypes.LoadingScreen, UIScreenTypes.GameScreen,UIScreenTypes.GameBG, UIScreenTypes.InGameScreenHud, UIScreenTypes.AsthericWoodsGameScreen });
